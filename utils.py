...
def get_data_iters(conf, gpu):
    ...
    iters = [[data_prefetcher(loader, batch_size, gpu) for loader in loaders] for loaders in loaders]
...
class data_prefetcher():
    def __init__(self, loader, batch_size, gpu):
        self.loader = loader
